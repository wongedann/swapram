...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/wongedann/swapram/master/dropbear-ws.py.txt
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/wongedann/swapram/master/ws-stunnel.txt
